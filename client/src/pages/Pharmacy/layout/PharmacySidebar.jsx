...
const MENU_ITEMS = [
  ...
  },
  {
    ...
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 11H5m14 0a2 2 0 002-2V7a2 2 0 00-2-2h-4a2 2 0 01-2-2H9a2 2 0 01-2 2H5a2 2 0 00-2 2v2a2 2 0 002 2m14 0v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6" />
      </svg>
    )
  },
  {
